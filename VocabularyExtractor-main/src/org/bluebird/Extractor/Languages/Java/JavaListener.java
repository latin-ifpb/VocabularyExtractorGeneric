...
public class JavaListener extends JavaParserBaseListener {
    ...
    public void enterFieldDeclaration(JavaParser.FieldDeclarationContext ctx) {
        ...
        if (verificaConstante(fieldIdentifier) == false) {
            FileCreator.appendToVxlFile("\t\t\t<field name=\"" + fieldIdentifier + "\" type=\"" + typeField + "\" acess=\"" + this.modifiers + "\" loc=\"" + lineCount + "\">\n");
        } else {
            FileCreator.appendToVxlFile("\t\t\t<const name=\"" + fieldIdentifier + "\" type=\"" + typeField + "\" acess=\"" + this.modifiers + "\" loc=\"" + lineCount + "\">\n");
        }
        this.modifiers = "default";
    }
